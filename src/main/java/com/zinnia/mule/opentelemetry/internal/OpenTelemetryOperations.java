...
public class OpenTelemetryOperations {
   ...
   *            public void addCustomTags(@Connection OpenTelemetryConnection
   *            openTelemetryConnection,
   *            Map<String, String> tags,
   *            CorrelationInfo correlationInfo) {
   *            openTelemetryConnection.getTransactionStore().addTransactionTags(correlationInfo.getCorrelationId(),
   *            "custom",
   *            tags);
   *            }
   * 
